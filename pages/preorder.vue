        ...
        <v-row>
          <v-col>
            ...
            <v-btn
              ...
              color="accent"
              block
              @click.stop="showPreOrderReservation=true"
            >Continue to Reservation Placement</v-btn>
          </v-col>
        </v-row>
      </v-col>
    </v-row>
    <PreOrderReservation v-model="showPreOrderReservation"></PreOrderReservation>
  </v-container>
</template>
<script>
import ShoppingCart from "@/components/ShoppingCart.vue";
import PreOrderReservation from "@/components/PreOrderReservation.vue";
